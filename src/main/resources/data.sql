...
insert into customer_data (id, customers_name, customers_address, customers_zipcode, customers_city, customers_emailaddress, customers_phone_number) VALUES( 1, 'Piet Jansen', 'Straatweg 15', '3312 BE', 'Oordam', 'P.Jansen@mail.com', '12-99989723');
insert into customer_data (id, customers_name, customers_address, customers_zipcode, customers_city, customers_emailaddress, customers_phone_number, company_id) VALUES( 2, 'Piet Klaasens', 'Hoofdstraat2', '3312 BG', 'Oordam', 'pietKlaasens@mail.com', '12-93458739', 1);
insert into customer_data (id, customers_name, customers_address, customers_zipcode, customers_city, customers_emailaddress, customers_phone_number,  company_id) VALUES( 3, 'Jasper Dillemans', 'Straatje 23', '3312 BH', 'Oordam', 'J.P.Dillemans@mail.com', '12-77789891' , 2);

insert into customer_request (id, customer_data_id, machine_id, job_id, requested_start_time, requested_end_time ) VALUES( 1, 1, 1, 1, '2021-09-12T08:00:00', '2021-09-14T14:00:00');
...
INSERT INTO users (username, password, enabled) VALUES ('johan', '$2a$10$wPHxwfsfTnOJAdgYcerBt.utdAvC24B/DWfuXfzKBSDHO0etB1ica', TRUE);
